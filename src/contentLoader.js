...
export const wikiLinkMap = {
  ...
  'hip hop mafia': '/factions/hip-hop-mafia',
  'the hip hop mafia': '/factions/hip-hop-mafia',
  'made deck': '/hip-hop-mafia',
  'hip hop mafia roster': '/hip-hop-mafia',
  'grand verse': '/hip-hop-mafia/grand-verse',
  'freq kid': '/hip-hop-mafia/freq-kid',
  'vantaggios': '/factions/hip-hop-mafia',
  "vantaggio's": '/factions/hip-hop-mafia',
  "ma kade's": '/factions/hip-hop-mafia',
  'skillet & static': '/factions/hip-hop-mafia',
  'the velvet room': '/factions/hip-hop-mafia',
...
export const contentIndex = {
  factions: [
    { slug: 'dj24', name: 'DJ24', tagline: 'Structure, Unity, Control.', color: '#4F46E5', logo: '/images/logos/logo_dj24.png' },
    { slug: 'sick52', name: 'The Sick 52', tagline: 'They exiled us. Now we erase them.', color: '#DC2626', logo: '/images/logos/logo_sick_52.png' },
    { slug: 'hip-hop-mafia', name: 'Hip Hop Mafia', tagline: 'The beat is rented. The block is owned.', color: '#C9A227', logo: '/images/logos/logo_hip_hop_mafia.png' },
    { slug: 'harmony-council', name: 'Harmony Council', tagline: 'One sound, one rhythm, one world.', color: '#F59E0B', logo: '/images/logos/logo_harmony_council.png' },
    { slug: 'nexagen', name: 'NexaGen Harmonics', tagline: 'Power belongs to those who control it.', color: '#06B6D4', logo: '/images/logos/logo_nexagen_harmonics.png' },
    { slug: 'komedians', name: 'The Komedians', tagline: 'Reality is just a setup.', color: '#EC4899', logo: '/images/logos/logo_komedians.png' },
  ],
  characters: [
