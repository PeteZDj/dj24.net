...
function render(file, rect, W, H, style, octaves) {
  ...
  const layers = { districts: true, roads: true, buildings: true, rivers: true, pois: true, made: true, sick: true, labels: true, tenants: true };
...
for (const [tag, factor, oct] of [['region', 8, 5], ['metro', 26, 7], ['city', 70, 9], ['street', 210, 9]]) {
